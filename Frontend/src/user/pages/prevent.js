    ...
    <div>
      ...
      <div className="container-prevent">
          ...
          <div className="b1 b1-left">
            <img src="/image/prevent6.png" className="image1" />
          ...
          <div className="b1 b1-right">
            <img src="/image/prevent7.png" className="image1" />
          ...
          <div className="a1">
            <img src="/image/prevent4.png" className="image1" />
          ...
          <div className="a1">
            <img src="/image/prevent5.png" className="image1" />
            <p className="text-content">นัดเจอเพื่อรับของก่อนแล้วโอนทีหลัง</p>
          </div>
          <div className="a1">
            <img src="/image/prevent8.png" className="image1" />
